...
class AggregatorBase : public Aggregator {
  public:
    ...
    virtual ~AggregatorBase() { free(grid_data); }
    ...
    py::buffer_info buffer_info() {
        ...
        return py::buffer_info(grid_data,                                  /* Pointer to buffer */
...
class AggBaseString : public AggregatorBase<IndexType> {
  public:
    ...
    ~AggBaseString() {}
    virtual void set_data(StringSequence *string_sequence, size_t index) { this->string_sequence = string_sequence; }

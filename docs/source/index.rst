...
* Vaex is a **program** and **python library** to visualize and explore large tabular datasets.
...
* **Downloads**: :doc:`Standalone version or Python package <installing>`
* **More**: :doc:`gallery` | :doc:`program` | :doc:`Tutorial <tutorial_ipython_notebook>` | :doc:`API docs <api>` | :doc:`examples`
